...
public class ActivityServiceImplIntTest {
    ...
    private static Duration makeDuration(int hours, int minutes, int seconds) {
    ...
    public void testCreateAndFind() {
        ...
        Activity activity = Activity.build(new Date(), "Test", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
    ...
    public void testLoadAllForUser() {
        User user = userService.create(new User("test", "test", "test@test.com", true));
        Activity activity1 = Activity.build(new Date(), "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        Activity activity2 = Activity.build(new Date(), "Test2", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        Activity activity3 = Activity.build(new Date(), "Test3", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
    ...
    public void testFilterForCourseAndUser() {
        ...
        Activity activity1 = Activity.build(new Date(), "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        Activity activity2 = Activity.build(new Date(), "Test2", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        Activity activity3 = Activity.build(new Date(), "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        activityService.create(activity1);
        activityService.create(activity2);
        activityService.create(activity3);
    ...
    public void testFilterForCourseWrongUser() {
        ...
        Activity activity1 = Activity.build(new Date(), "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user1, ActivityType.RUN);
        Activity activity2 = Activity.build(new Date(), "Test2", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user1, ActivityType.RUN);
        Activity activity3 = Activity.build(new Date(), "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user1, ActivityType.RUN);
        activityService.create(activity1);
        activityService.create(activity2);
        activityService.create(activity3);
    ...
    public void testFilterForStartAndEndDate() {
        ...
        Activity activity1 = Activity.build(date1, "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        Activity activity2 = Activity.build(date2, "Test2", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        Activity activity3 = Activity.build(date3, "Test1", 5.2, makeDuration(0, 31, 2), "13 Sunny", "blabla", 125, user, ActivityType.RUN);
        activityService.create(activity1);
        activityService.create(activity2);
        activityService.create(activity3);
