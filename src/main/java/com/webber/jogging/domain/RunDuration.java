...
public class RunDuration implements Serializable {
    ...
    /**
     * Create a new RunDuration object, checking validity of the supplied arguments
     *
     * @param hours   The number of hours the run took (the assumption is made that no
     *                run will take more than 5 hours).
     * @param minutes The number of minutes.
     * @param seconds The number of seconds.
     * @throws IllegalArgumentException if any argument is invalid, i.e. 61 minutes.
     */
    public RunDuration(int hours, int minutes, int seconds) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RunDuration)) return false;
        RunDuration other = (RunDuration) obj;
